...
class DataFormReadOnly(forms.ModelForm):
    field_text_1 = FormCharField(
        widget=forms.TextInput(
            attrs={
                "autofocus": True,
    ...
    field_password = FormPasswordField(
        widget=forms.PasswordInput(
            attrs={"placeholder": "Password", "readonly": "readonly"},
            render_value=True,
        ),
        help_text="Help field_password",
    )
    field_password_confirm = FormPasswordField(
        widget=forms.PasswordInput(
            attrs={"placeholder": "Password confirmation", "readonly": "readonly"},
            render_value=True,
        ),
        help_text="Help field_password_confirm",
    )
